...
if __name__ == "__main__":
    ...
    hyper_rnn = load_pkl("HyperRNNAgent_MaterialTransport/metrics.pkl")
    rnn_exp = load_pkl("HyperRNNAgent_MaterialTransport/metrics.pkl")
    rnn_imp = load_pkl("HyperRNNAgent_MaterialTransport/metrics.pkl")
    # rnn_exp = (load_pkl("RNNEXPAgent_MaterialTransport/metrics.pkl"), "RNNEXP")
    # rnn_imp = (load_pkl("RNNIMPAgent_MaterialTransport/metrics.pkl"), "RNNIMP")
